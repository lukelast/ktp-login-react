          ...
          <div className="ktp-space-y-3">
            ...
            {enabledProviders.includes(GithubAuthProvider.PROVIDER_ID) && (
              <button
                ...
                className="ktp-btn-oauth"
              >
                <svg className="ktp-btn-icon" fill="currentColor" viewBox="0 0 20 20">
                  <title>GitHub</title>
                  <path
                    fillRule="evenodd"
            ...
            {enabledProviders.includes(FacebookAuthProvider.PROVIDER_ID) && (
              <button
                ...
                className="ktp-btn-oauth"
              >
                <svg className="ktp-btn-icon" fill="#1877F2" viewBox="0 0 24 24">
            ...
            {enabledProviders.includes(EmailAuthProvider.PROVIDER_ID) && (
              <button
                ...
                disabled={isLoading}
              >
                <svg className="ktp-btn-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span>Send Email login link</span>
              </button>
            )}
